...
export function exportCsv({ data, result }) {
  const rows = [
    ...
    ["Carico massimo prova kN", data.testLoad, "Lunghezza m", data.length, "Martinetto fisso", "30 ton", "Rif. kN", fmt(result.pressureReferenceLoadKn, 2), "Manometro", "700 bar"],
    [],
    ["N", "Ciclo", "Percentuale", "Pressione bar", "Carico step kN", "Rif. martinetto kN", "Cedimento medio mm", "Comparatore 1", "Comparatore 2", "Comparatore 3"],
